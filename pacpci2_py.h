...
DLL_API unsigned char  checkChannelHardwarePresent(short chanID);
DLL_API unsigned char  checkChannelParametricPresent(short ParametricId); 
...
DLL_API void  setDigitalOutput(int bitId, unsigned char on_off); 
